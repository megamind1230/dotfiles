...
;; ----------------------------------------------------------------------
;; 1. Core Configuration for company-mode
;; ----------------------------------------------------------------------
(use-package company
  :ensure t
  :init
...
;; ----------------------------------------------------------------------
;; 2. Core Configuration for lsp-mode (Language Server Protocol client)
;; ----------------------------------------------------------------------
(use-package lsp-mode
  :ensure t
  :init
  ;; Set the prefix key for lsp-mode commands (e.g., C-c l)
  (setq lsp-keymap-prefix "C-c l")
  :hook
  ;; Enable lsp-mode automatically in csharp-mode (for .NET)
  (csharp-mode . lsp-deferred)
  :commands (lsp lsp-deferred)
  :config
  ;; Crucially, tell lsp-mode NOT to manage company backends. 
  ;; This allows our manual company setup to work cleanly with yasnippet if you use it.
  (setq lsp-completion-provider :none))

;; Optional: For nice UI elements like a breadcrumb bar at the top of the window
(use-package lsp-ui
  :ensure t
...
;; 3. C# Language Server
;; ----------------------------------------------------------------------
;; C# support is built into lsp-mode. Install the server with:
;; M-x lsp-install-server RET csharp-ls
;; Or: M-x lsp-install-server RET omnisharp
